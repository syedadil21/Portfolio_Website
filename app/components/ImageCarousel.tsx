  ...
  return (
    <>
      <div className="space-y-4">
        {/* Main image with gradient frame */}
        <div className="relative group">
          ...
          <div
            className="relative rounded-2xl overflow-hidden border border-white/10 bg-gradient-to-br from-zinc-950 to-black aspect-video cursor-zoom-in"
          ...
          >
            ...
            {/* Gradient overlay on hover for caption readability */}
          ...
          {/* Nav arrows — outside the image for cleaner look */}
          {images.length > 1 && (
            <>
              <button
